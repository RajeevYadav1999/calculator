                ...
                <div className='mae-cad-info-section-main-section-info'>
                    ...
                    <section className='mae-cad-info-view-second-section-main-grid'>
                        <div className='mae-cad-info-second-section-main-grid-text'>
                            <h2 className='mae-cad-info-second-section-main-grid-text-h2-heading'>Machining </h2>
                            <h2 className='mae-cad-info-second-section-main-grid-text-p-defination'>Cutting tools are used to remove material from a workpiece to create the desired shape.</h2>
                        ...
                        <div className='mae-cad-info-second-section-main-grid-image'>
                            ...
                            <div className={isToggled ? 'mae-cad-info-second-section-main-grid-image-overlay':' mae-cad-info-second-section-main-grid-image-overlay fullscreen-btn'}>
                                <button className='mae-cad-info-second-section-main-grid-image-overlay-button'><Link to='/Mechcinal/cam/topics/machining/types'>TYPES</Link></button>
                            </div>
                        </div>
                    </section>
                    <br/>

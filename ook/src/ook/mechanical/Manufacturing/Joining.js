        ...
        <>
            ...
            <nav className="mae-cad-info-leftside-navbar">
                ...
                <div className='mae-cad-info-section-main-section-info'>
                    <br />
                    <br />
                    <div className='mae-cad-info-section-main-section-info-sec-nav'><p className='mae-cad-info-section-main-section-info-sec-nav-p'>CAD <AiOutlineRight /> <span> JOINING</span></p></div>
                    <hr />
                    <br />
                    <br />
                    ...
                    <section className='mae-cad-info-view-second-section-main-grid'>
                        <div className='mae-cad-info-second-section-main-grid-text'>
                            <h2 className='mae-cad-info-second-section-main-grid-text-h2-heading'>JOINING </h2>
                            <h2 className='mae-cad-info-second-section-main-grid-text-p-defination'>Joining two or more components or materials together to create a single, u structure or product.</h2>
                        </div>
                        <div className='mae-cad-info-second-section-main-grid-image'>
                            ...
                            <div className={isToggled ? 'mae-cad-info-second-section-main-grid-image-overlay' : ' mae-cad-info-second-section-main-grid-image-overlay fullscreen-btn'}>
                                <button className='mae-cad-info-second-section-main-grid-image-overlay-button'><Link to='/Mechcinal/cam/topics/joining/types'>TYPES</Link></button>
                            </div>
                        </div>
                    </section>
                    <br />

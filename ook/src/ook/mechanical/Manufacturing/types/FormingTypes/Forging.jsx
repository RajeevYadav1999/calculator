        ...
        <Swiper watchSlidesProgress={true} slidesPerView={3} className="mySwiper" loop={true}>
          ...
          <SwiperSlide className={isActive ? 'mae-drawing-slider-slide-1 aligh-all' : ' mae-drawing-slider-slide-1'}>
            ...
            <div>
              ...
              <p>Reshaping of metal when it is heated to a high temperature, typically above its recrystallization temperature, which reduces its strength and force required to change the shape and size.
                Improve mechanical properties like ductility, toughness and strength due to grain formation.
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide className={isActive ? 'mae-drawing-slider-slide-1 aligh-all' : ' mae-drawing-slider-slide-1'}>
            ...
            <div>
              ...
              <p>Reshaping of metal when it is heated above the room temperature but below the recrystallization temperature typically between 800 and 1000 degrees. Less force is required than hot forging and increased ductility.
                improve the precision quality of forgings
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide className={isActive ? 'mae-drawing-slider-slide-1 aligh-all' : ' mae-drawing-slider-slide-1'}>

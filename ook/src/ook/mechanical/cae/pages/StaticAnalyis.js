        ...
        <>
            ...
            <section className='cae-first-section' >
                <div className='cae-first-section-div first' >
                    ...
                    <div className='cae-first-section-textdiv'>
                        <h3 className='cae-first-section-textdiv-h1'>Static Analyis</h3>
            ...
            <section className='cae-sec-section'>
                <div className="cse-info-box first">
                    ...
                    <div className="cse-info-box__description">
                        <div className="cse-info-box__inner">
                            <h4 className="cse-info-box__title"> <a href="#">Linear Analyis</a><i className="cse-fa fa-chevron-right" aria-hidden="true" ><IoIosArrowDown /></i>
                            </h4>
                            <div className="cse-info-box__hidden">
                                <p>Canthigaster rostrata spikefish brown trout loach summer flounder.
                                    European minnow black dragonfish orbicular</p><a className="cse-info-box__link with--line" href="#"><Link to="/Mechcinal/cae2/StaticAnalyis/LinearAnalyis">Explore more <BsArrowRight /></Link></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="cse-info-box second">
                    ...
                    <div className="cse-info-box__description">
                        <div className="cse-info-box__inner">
                            <h4 className="cse-info-box__title"> <a href="#">Non-Linear Analyis</a><i className="cse-fa fa-chevron-right" aria-hidden="true" ><IoIosArrowDown /></i>
                            </h4>
                            <div className="cse-info-box__hidden">
                                <p>Canthigaster rostrata spikefish brown trout loach summer flounder.
                                    European minnow black dragonfish orbicular</p><a className="cse-info-box__link with--line" href="#"><Link to="/Mechcinal/cae2/StaticAnalyis/NonLinearAnalyis">Explore more <BsArrowRight /></Link></a>
                            </div>
                        </div>
                    </div>
                </div>

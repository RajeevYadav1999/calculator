...
export default function NonLinearAnalyis() {
  return (
<>
      ...
      <section className='cae-first-section' >
        <div className='cae-first-section-div first' >
          ...
          <div className='cae-first-section-textdiv'>
            <h3 className='cae-first-section-textdiv-h1'>Non-Linear Analyis</h3>
      ...
      <section className='cae-sec-section'>
        <div className="cse-info-box first">
          ...
          <div className="cse-info-box__description">
            <div className="cse-info-box__inner">
              <h4 className="cse-info-box__title"> <a href="#">Pre Processing</a><i className="cse-fa fa-chevron-right" aria-hidden="true" ><IoIosArrowDown /></i>
              </h4>
        ...
        <div className="cse-info-box second">
          ...
          <div className="cse-info-box__description">
            <div className="cse-info-box__inner">
              <h4 className="cse-info-box__title"> <a href="#">Meshing</a><i className="cse-fa fa-chevron-right" aria-hidden="true" ><IoIosArrowDown /></i>
              </h4>
              <div className="cse-info-box__hidden">
                <p>Canthigaster rostrata spikefish brown trout loach summer flounder.
        ...
        <div className="cse-info-box first">
          ...
          <div className="cse-info-box__description">
            <div className="cse-info-box__inner">
              <h4 className="cse-info-box__title"> <a href="#">Post Processing</a><i className="cse-fa fa-chevron-right" aria-hidden="true" ><IoIosArrowDown /></i>
              </h4>
              <div className="cse-info-box__hidden">
                <p>Canthigaster rostrata spikefish brown trout loach summer flounder.

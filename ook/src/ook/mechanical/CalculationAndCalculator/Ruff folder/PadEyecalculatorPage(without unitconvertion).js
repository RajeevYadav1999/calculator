...
export default function PadEyecalculatorPage() {
    ...
    const [MaterialYieldStresInMPa, setMaterialYieldStresInMPa] = useState('');

    const handleMaterialYieldStresChange = (value) => {
        setMaterialYieldStresValue(value);
        const valueInMPa = parseFloat(value) / MaterialYieldStressconversionFactors[MaterialYieldStresselectedUnit];
        setMaterialYieldStresInMPa(valueInMPa);
    };
    const handleMaterialYieldStreschange = (unit, exponent = 1) => {
        ...
        const valueInMPa = parseFloat(convertedValue) / MaterialYieldStressconversionFactors[unit];
        setMaterialYieldStresInMPa(valueInMPa);
    };
    ...
    const handleLoadinVerticalDirectionZdirectionselectedUnitChange = (unit) => {
        ...
        setLoadinVerticalDirectionZdirectionValue((parseFloat(LoadinVerticalDirectionZdirectionValue) * factor));
    };
    ...
    }, [LoadonPadeyeValue, AngleofLoadwithVerticalvalue, DLFValue,OutofPlaneAngleValue]); // Dependencies to ensure calculation runs when these values change
    ...
    }, [LoadonPadeyeValue,DLFValue,AngleofLoadwithVerticalvalue,OutofPlaneAngleValue,DesignLoadOutofPlaneLateralXdirection, ShearAreaatBaseHorizontal]);
    ...
    const handleWeldStressatCheekWeldActualUnitChange = (unit) => {
        ...
        setWeldStressatCheekWeldActual((parseFloat(WeldStressatCheekWeldActual) / DesignLoadononecheekplateFactor));
    };

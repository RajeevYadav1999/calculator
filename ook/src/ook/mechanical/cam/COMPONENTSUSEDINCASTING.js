...
import CASTINGPROPERTIESOFMATERIAL_Slider from './COMPONENTSUSEDINCASTING Slider.js'
        ...
        <>
            ...
            <section className={isToggled ? 'mae-cad-info-section fullscreen' : 'mae-cad-info-section'}>
                ...
                <div className='mae-cad-info-section-main-section-info'>
                    ...
                    <br />
                    <br />
                    <CASTINGPROPERTIESOFMATERIAL_Slider/>
                    {/* <div className='SheetMetal mae-cad-info-views-explore-more-section-blue-text mae-cad-info-blue-section-main active '>
                        ...
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill />Replica of the object to be cast, used to prepare the cavity into which molten</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>  </h3>
                        
                        <h3 className='mae-cad-info-blue-section-main-topic'>Mold or Die</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /></h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> </h3>

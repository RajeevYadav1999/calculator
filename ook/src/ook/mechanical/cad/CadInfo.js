        ...
        <>
            ...
            <section className={isToggled ? 'mae-cad-info-section' : 'mae-cad-info-section fullscreen'}>
                <nav className="mae-cad-info-leftside-navbar">
                    ...
                    <ul className={isToggled ? 'mae-cad-info-leftside-navbar-navbar-nav' : 'mae-cad-info-leftside-navbar-navbar-nav unactive'}>
                        ...
                        >
                            ...
                            {isMenuActive(1) && (
                                <div className="mae-cad-info-leftside-navbar-dropdown-menu">
                                    ...
                                    <hr />
                                    <a href="#" className="mae-cad-info-leftside-navbar-dropdown-menu-dropdown-link" onClick={handleToggle}><Link to='/Mechcinal/cad/sketching/EditingTools'>Editing tools </Link></a>
                                    <hr />
                        ...
                        >
                            ...
                            {isMenuActive(2) && (
                                <div className="mae-cad-info-leftside-navbar-dropdown-menu">
                                    <li className='mae-cad-info-leftside-navbar-dropdown-menu-dropdown-li'><a href="#" className="mae-cad-info-leftside-navbar-dropdown-menu-dropdown-link" alt=''><Link to='/Mechcinal/cad/3dModeling/partModlling'>Solid Modeling <span className='mae-cad-info-leftside-navbar-dropdown-menu-dropdown-link-span-space'>(3D)</span></Link>
                        ...
                        >
                            ...
                            {isMenuActive(4) && (
                                <div className="mae-cad-info-leftside-navbar-dropdown-menu">
                                    <a href="#" className="mae-cad-info-leftside-navbar-dropdown-menu-dropdown-link"><Link to='/Mechcinal/cad/DRAFTING/VIEWS'>VIEWS</Link></a>
                                    <hr />
                                    <a href="#" className="mae-cad-info-leftside-navbar-dropdown-menu-dropdown-link"><Link to='/Mechcinal/cad/assembly/Bottom-down'>ANNOTATION</Link></a>
                                </div>
                            )}
                        </li>
                    </ul>
                ...
                <div className='mae-cad-info-section-main-section-info'>
                    <br />
                    <br />
                    <div className='mae-cad-info-section-main-section-info-sec-nav'><p className='mae-cad-info-section-main-section-info-sec-nav-p'>CAD <AiOutlineRight /> Sketching <AiOutlineRight /><span> Sketch tools</span></p></div>
                    <hr />

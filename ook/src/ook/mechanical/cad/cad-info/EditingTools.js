        ...
        <>
            ...
            <section className={isToggled ? 'mae-cad-info-section' : 'mae-cad-info-section fullscreen'}>
                ...
                <div className='mae-cad-info-section-main-section-info'>
                    <br />
                    <br />
                    <div className='mae-cad-info-section-main-section-info-sec-nav'><p className='mae-cad-info-section-main-section-info-sec-nav-p'>CAD <AiOutlineRight /> 3d Modeling <AiOutlineRight /> Part Modlling<AiOutlineRight /><span>Editing Tools</span></p></div>
                    <hr />
                    <br/>
                    <div className='mae-cad-info-blue-section-main'>
                        <br />

                        <h3 className='mae-cad-info-blue-section-main-topic'>Mirror</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill />Allow the user to create a mirror replica of the body.</h3>
                        <br />

                        <h3 className='mae-cad-info-blue-section-main-topic'>Patten</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill />Create replicas of the bodies in a patterned manner along a specified </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'> axis or within a specific area.</h3>
                        <br />

                        <h3 className='mae-cad-info-blue-section-main-topic'>Fillet</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> Remove the sharp corner by making the rounded surface over the edge also </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'> improving the aesthetics of the design and reducing stress concentrations.</h3>
                        <br />

                        <h3 className='mae-cad-info-blue-section-main-topic'>Chamfer</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> Allow the user to move or copy the 3d model. </h3>
                        <br />

                        <h3 className='mae-cad-info-blue-section-main-topic'>Move And Copy The Body</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> Allow the user to move or copy the 3d model. </h3>

                        <br />
                        <h3 className='mae-cad-info-blue-section-main-topic'>Delete Body</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill />Allows the user to delete the body. </h3>
                        <br />

                        <h3 className='mae-cad-info-blue-section-main-topic'>  Split Body</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill />Allows the user to split the body into two different bodies.</h3>
                        <br />

                        <h3 className='mae-cad-info-blue-section-main-topic'>  Combine </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> Allow the user to combine a number of bodies into a single body.</h3>
                        <br />

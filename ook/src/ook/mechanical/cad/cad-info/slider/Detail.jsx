...
//                 <li className='mae-drawing-slider-nav-topics'><Link to='/Mechcinal/cam/topics/forming/types/forgingProcesses'>Forging Processes</Link></li>
//                     <li className='mae-drawing-slider-nav-topics'><Link to='/Mechcinal/cam/topics/forming/types/rollingProcesses'>Rolling Processes</Link></li>
...
//               <div>
//                 <p><strong>According to temperature</strong></p>
//                 {/* <p>The all-new RX is both aesthetically stunning and functional. It exudes a seductive yet strong presence, and the signature spindle body design offers excellent airflow to keep the vehicle cool.</p> */}
//               </div>
//             </SwiperSlide>
//             <SwiperSlide className={isActive ? 'mae-drawing-slider-slide-1 aligh-all' : ' mae-drawing-slider-slide-1'}>
//               <img src={slide_image_2} alt="slide_image" />
//               <div>
//                 <p><strong>According to the roller type</strong></p>

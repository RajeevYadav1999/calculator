        ...
        <>
            ...
            <section className={isToggled ? 'mae-cad-info-section' : 'mae-cad-info-section fullscreen'}>
                ...
                <div className='mae-cad-info-section-main-section-info'>
                    <br />
                    <br />
                    <div className='mae-cad-info-section-main-section-info-sec-nav'><p className='mae-cad-info-section-main-section-info-sec-nav-p'>CAD <AiOutlineRight /> Modeling <AiOutlineRight /><span>Weldments</span></p></div>
                    <hr />
<br/>
<br/>
                    <section className='mae-cad-info-view-second-section-main-grid'>
                        <div className='mae-cad-info-second-section-main-grid-text'>
                            <h2 className='mae-cad-info-second-section-main-grid-text-h2-heading'>Weldments </h2>
                            <h2 className='mae-cad-info-second-section-main-grid-text-p-defination'>Structural members are welded together to form the structure. Rather than using conventional assemblies, designers can create complex welded structures as a single multibody part. </h2>
                    ...
                    <br/>
                    <div className={isActive ? 'weldments mae-cad-info-views-explore-more-section-blue-text mae-cad-info-blue-section-main ': 'weldments mae-cad-info-views-explore-more-section-blue-text mae-cad-info-blue-section-main active '}>
                        <br />

                        <h3 className='mae-cad-info-blue-section-main-topic'>Structural Members</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> These are the primary units of a weldment structure, which could be</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'> standard shapes like tubes, pipes, or angle sections, made from materials </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>such as steel or aluminium.</h3>
                        

                        <h3 className='mae-cad-info-blue-section-main-topic'>Trim/Extend Feature</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> Allows the user to precisely control the extending or trimming of </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>structural members where they meet.</h3>

                        <h3 className='mae-cad-info-blue-section-main-topic'>End Cap Feature</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill />  Allow the user to close the open ends of hollow structural members like tubes  </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>or pipes.</h3>

                        <h3 className='mae-cad-info-blue-section-main-topic'>Gusset Feature</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> Allows the user to create the gusset plates to connect beams and columns or to </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>connect truss members. </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> Provide additional strength and stability to the overall structure by distributing  </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>the forces and loads at the connection points.  </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> The size and thickness of gusset plates vary depending on the specific design  </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>requirements and the magnitude of the loads they need to support. </h3>

                        <h3 className='mae-cad-info-blue-section-main-topic'>Weld Beads</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill />Allow the user to simulate a real-life weld in your design. </h3>

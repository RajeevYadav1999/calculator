...
// export default function PartModelling() {
...
//                                     </a>
//                                     <hr />
//                                     <a href="#" className="mae-cad-info-leftside-navbar-dropdown-menu-dropdown-link">Sheet metal </a>
//                                     <hr />
//                                     <a href="#" className="mae-cad-info-leftside-navbar-dropdown-menu-dropdown-link">Weldments</a>
//                                     <hr />
//                                     <a href="#" className="mae-cad-info-leftside-navbar-dropdown-menu-dropdown-link">Surface Modeling <span className='mae-cad-info-leftside-navbar-dropdown-menu-dropdown-link-span-space'>(2D)</span></a>
//                                 </div>
//                             )}
//                         </li>
//                         <hr />
...
//                     <br />
//                     <br />
//                     <div className='mae-cad-info-section-main-section-info-sec-nav'><p className='mae-cad-info-section-main-section-info-sec-nav-p'>CAD <AiOutlineRight /> 3d Modeling <AiOutlineRight /><span> Part Modlling</span></p></div>
//                     <hr />
//                     <br/>
//                     <br/>
...
//                             <h2 className='mae-cad-info-second-section-main-grid-text-h2-heading'>3d Modelling</h2>
//                             <h2 className='mae-cad-info-second-section-main-grid-text-p-defination'>Creation of a 3d representation of the model with the<br/> help of a computer also known as computer-aided modelling (CAD). </h2>
...
//                                 <button className='mae-cad-info-second-section-main-grid-image-overlay-button'><Link to='/Mechcinal/cad/3dModeling/partModlling/types'>TYPES</Link></button>
//                             </div>
//                         </div>
//                     </section>
//                     {/* <br/>

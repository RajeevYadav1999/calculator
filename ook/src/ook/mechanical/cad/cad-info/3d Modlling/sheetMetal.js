        ...
        <>
            ...
            <section className={isToggled ? 'mae-cad-info-section' : 'mae-cad-info-section fullscreen'}>
                ...
                <div className='mae-cad-info-section-main-section-info'>
                    <br />
                    <br />
                    <div className='mae-cad-info-section-main-section-info-sec-nav'><p className='mae-cad-info-section-main-section-info-sec-nav-p'>CAD <AiOutlineRight /> Modeling <AiOutlineRight /><span>Sheet Metal</span></p></div>
                    <hr />
                    <br />
                    <br />
                    <section className='mae-cad-info-view-second-section-main-grid'>
                        <div className='mae-cad-info-second-section-main-grid-text'>
                            <h2 className='mae-cad-info-second-section-main-grid-text-h2-heading'>Sheet Metal  </h2>
                            <h2 className='mae-cad-info-second-section-main-grid-text-p-defination'>Creation of virtual representation of the 3D model of sheet metal part with the help of CAD software.</h2>
                    ...
                    <div className={isActive ? 'SheetMetal mae-cad-info-views-explore-more-section-blue-text mae-cad-info-blue-section-main ': 'SheetMetal mae-cad-info-views-explore-more-section-blue-text mae-cad-info-blue-section-main active '}>
                        ...
                        <h3 className='mae-cad-info-blue-section-main-topic'>Bend</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> Allow the user to flex the sheet metal part at a specified bend radius and angle.</h3>


                        <h3 className='mae-cad-info-blue-section-main-topic'>Flange</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> This tool creates a bend extending from an existing part edge. </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> It allows you to control the bend radius, flange length, and the angle of the flange.</h3>

                        <h3 className='mae-cad-info-blue-section-main-topic'>Miter Flange</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> This allows the user to create complex shapes and bend configurations and is </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>particularly useful for creating edge flanges that must travel along several edges.</h3>

                        <h3 className='mae-cad-info-blue-section-main-topic'>Hem</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> Allows the user to create a rolled edge on sheet metal, used for aesthetic purposes, to </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>increase part stiffness, or to protect the edges from being sharp and possibly dangerous to </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>handle.</h3>

                        <h3 className='mae-cad-info-blue-section-main-topic'>Cut</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> Allow the user to remove material and create holes, slots, or other cut-outs in the sheet </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>metal part.</h3>

                        <h3 className='mae-cad-info-blue-section-main-topic'>Corner Relief</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill />  Allow the user to remove material from specific areas near the bends for </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>smooth and even deformation during the bending process. The relief can be in the form of </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>notches, cuts, or rounded corners. This reduces the amount of material subjected to extreme </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>stretching or compression during bending, which helps maintain the overall integrity of the </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>sheet metal part.</h3>

                        <h3 className='mae-cad-info-blue-section-main-topic'>  Unfolding</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill />  Allow the user to flatten the selected bends.</h3>

                        <h3 className='mae-cad-info-blue-section-main-topic'>  Folding</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> Allow the user to fold the selected bends.</h3>

                        <h3 className='mae-cad-info-blue-section-main-topic'>  Form</h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> Form features, like louvres, lances, or embosses, are added using forming tools, </h3>
                        <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>representing complex three-dimensional shapes that are pressed into the sheet metal.</h3>

...
export default function AssemblyBottomDown() {
                ...
                <div className='mae-cad-info-section-main-section-info'>
                    ...
                    <section className='mae-cad-info-view-second-section-main-grid'>
                        <div className='mae-cad-info-second-section-main-grid-text'>
                            <h2 className='mae-cad-info-second-section-main-grid-text-h2-heading'>Assembly Bottom-Down </h2>
                            <h2 className='mae-cad-info-second-section-main-grid-text-p-defination'>Parts are called from outside and assembly to make the finished product in the assembly interface.</h2>

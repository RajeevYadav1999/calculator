        ...
        <>
            ...
            <section className={isToggled ?   'mae-cad-info-section fullscreen':'mae-cad-info-section'}>
                        ...
                        >
                            ...
                            {isMenuActive(4) && (
                                <div className="mae-cad-info-leftside-navbar-dropdown-menu">
                                    ...
                                    <hr />
                                    <li href="#" className="mae-cad-info-leftside-navbar-dropdown-menu-dropdown-link"><Link to='/Mechcinal/cad/DRAFTING/Annotations'>ANNOTATION</Link></li>
                                </div>
                            )}
                        </li>
                    </ul>
                ...
                <div className='mae-cad-info-section-main-section-info'>
                    <br />
                    <br />
                    <div className='mae-cad-info-section-main-section-info-sec-nav'><p className='mae-cad-info-section-main-section-info-sec-nav-p'>CAD <AiOutlineRight /> DRAFTING <AiOutlineRight /><span> Annotations</span></p></div>
                    <hr />
                    <br/>
                    <br/>
                    ...
                    <section className='mae-cad-info-view-second-section-main-grid'>
                        <div className='mae-cad-info-second-section-main-grid-text'>
                            <h2 className='mae-cad-info-second-section-main-grid-text-h2-heading'>Annotations  </h2>
                            <h2 className='mae-cad-info-second-section-main-grid-text-p-defination'>Annotations refer to the text, dimensions, symbols, and other graphical elements added to a drawing to provide additional information and clarify the design intent. They are essential for communicating specifications like tolerances, surface finish and other details to the manufacturer the drawing.</h2>
                        ...
                        <div className='mae-cad-info-second-section-main-grid-image'>
                            ...
                            <div className={isToggled ? 'mae-cad-info-second-section-main-grid-image-overlay':' mae-cad-info-second-section-main-grid-image-overlay fullscreen-btn'}>
                                <button className='mae-cad-info-second-section-main-grid-image-overlay-button'><Link to='/Mechcinal/cad/DRAFTING/Annotations/types'>TYPES</Link></button>
                            </div>
                        </div>
                    </section>
                    <br/>

...
export default function AssemblyTopDown() {
                ...
                <div className='mae-cad-info-section-main-section-info'>
                    ...
                    <section className='mae-cad-info-view-second-section-main-grid'>
                        <div className='mae-cad-info-second-section-main-grid-text'>
                            <h2 className='mae-cad-info-second-section-main-grid-text-h2-heading'>Assembly Top-Down </h2>
                            <h2 className='mae-cad-info-second-section-main-grid-text-p-defination'>Parts are created and assembled inside the assembly interface.</h2>

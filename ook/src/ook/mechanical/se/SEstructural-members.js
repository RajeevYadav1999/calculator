...
export default ImageScrollEffect;  
                ...
                //         <h3 className='mae-cad-info-blue-section-main-topic'>Beam </h3>
                //         <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill />Horizontal member of a structure that supports vertical or lateral loads.</h3>
                //         <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill />Beams are subjected to higher bending and shearing due to vertical or</h3>
                //         <h3 className='mae-cad-info-blue-section-main-decsription not-icon'> lateral load.</h3>
                        
                //         <h3 className='mae-cad-info-blue-section-main-topic'>Columns</h3>
                //         <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> Vertical members of a structure that are subjected to Axial compressive </h3>
                //         <h3 className='mae-cad-info-blue-section-main-decsription not-icon'>loads and transferring the structure's weight to the foundations.</h3>


                //         <h3 className='mae-cad-info-blue-section-main-topic'>Braces</h3>
                //         <h3 className='mae-cad-info-blue-section-main-decsription'><GoDotFill /> Diagonal Members of the structure between two beams or two columns or </h3>
                //         <h3 className='mae-cad-info-blue-section-main-decsription not-icon'> between beams and column of the structure that resist lateral loads,</h3>
                //         <h3 className='mae-cad-info-blue-section-main-decsription not-icon'> helping to stabilize the structure.</h3>

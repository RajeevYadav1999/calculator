...
//                                     <h5 className="title">Machine Learning</h5><a className="with--line" href="Swiftwave AHC System Varient.html">Explore more</a>
//                                 </div>
//                             </div>
...
//                                 <div className="overlay" /><img className="img-bg" src={Frontend} alt="img" /></a>
//                                 <div className="description">
//                                     <h5 className="title">Robotics</h5><a className="with--line" href="cases-details.html">Explore more</a>
//                                 </div>
//                             </div>
...
//                                 <div className="overlay" /><img className="img-bg" src={Frontend} alt="img" /></a>
//                                 <div className="description">
//                                     <h5 className="title">AI in Healthcare</h5><a className="with--line" href="cases-details.html">Explore more</a>
//                                 </div>
//                             </div>

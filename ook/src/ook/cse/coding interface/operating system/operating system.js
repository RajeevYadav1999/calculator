...
//                                     <h5 className="title">Process Management</h5><a className="with--line" href="Swiftwave AHC System Varient.html">Explore more</a>
//                                 </div>
//                             </div>
...
//                                 <div className="overlay" /><img className="img-bg" src={Frontend} alt="img" /></a>
//                                 <div className="description">
//                                     <h5 className="title">Memory Management</h5><a className="with--line" href="cases-details.html">Explore more</a>
//                                 </div>
//                             </div>
...
//                                 <div className="overlay" /><img className="img-bg" src={Frontend} alt="img" /></a>
//                                 <div className="description">
//                                     <h5 className="title">File Protection and Security</h5><a className="with--line" href="cases-details.html">Explore more</a>
//                                 </div>
//                             </div>
